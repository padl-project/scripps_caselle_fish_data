...
fish_data <- read_csv(glue("{dir_gdrive}/DATA_RAW/Scripps_Caselle_Fish_Data/PARC_FISH_DATA_Temporary.csv")) %>% 
  clean_names()

site_list <- read_excel(glue("{dir_gdrive}/DATA_RAW/Scripps_Caselle_Fish_Data/PARC_SITE_LIST_Temporary.xlsx")) %>% 
  clean_names()
...
- Make `project` categorical 
- Make `transect` categorical
- Make 999999 NA for depth_zn
...
fish_data_clean <- fish_data %>% 
  ...
  select(-diver_tx_depthzn, -station)

fish_data_clean[fish_data_clean == 999999] <- NA


write_csv(fish_data_clean, glue("{dir_gdrive}/DATA_RAW/Scripps_Caselle_Fish_Data/clean_data/scripps_caselle_fish_data.csv"))
...
write_csv(site_list_clean, glue("{dir_gdrive}/DATA_RAW/Scripps_Caselle_Fish_Data/clean_data/scripps_caselle_site_list.csv"))
```
